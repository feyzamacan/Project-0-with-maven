...
//implements the methods defined in UsersDao interface
//talk to the database for User-related operations
//This class is a DAO implementation responsible for all database operations related to users
//uses JDBC w prep statements, stored procedures, and transactions to perform CRUD operations
...
public class UsersDaoImp implements UsersDao {
 ...
 private static final String SQLSTATE_NO_RESULTS = "99999";
  ...
  public int deleteUser(Connection con, User u)  throws SQLException {
    try(PreparedStatement stmtP = con.prepareStatement(SQL_SELECT_USER)) { //change to SQL_DELETE_USER?
      stmtP.setString(1, u.getUsername());
      stmtP.executeUpdate();
    }
    return 0;
